...
<body>
	...
	<%
		// Look at all of our greetings
			for (Greeting greeting : greetings) {
				...
				pageContext.setAttribute("greeting_id", greeting.id);
				String author;
	...
	<div>
		...
		%>
		<form action="/sign" method="DELETE">
			<div>
				<input type="submit" value="DELETE" />
			</div><input type="hidden" name="guestbookName"
			value="${fn:escapeXml(guestbookName)}" />
			<input type="hidden" name="greet_id"
				value="${fn:escapeXml(greeting_id)}" />
		</form>
		<%
			}
				}
